...
urlpatterns = [
    ...
    path('qr-deelnemer-event/', views.create_qr_deelnemer_and_event, name='create-qr-deelnemer-event'),
    path('qr-code-page.html', views.qr_code_page_view, name='qr_code_page'),
